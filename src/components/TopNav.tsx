...
export function TopNav() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[#080808]/60 backdrop-blur-xl border-b border-white/15 shadow-[0_0_20px_rgba(162,255,191,0.08)] flex justify-between items-center h-16 px-8">
      <div className="text-2xl font-black tracking-tighter text-[#a2ffbf] font-headline cursor-pointer transition-transform duration-300 hover:scale-105 active:scale-95">
        MONOLITH
      </div>
      ...
      <div className="flex items-center gap-6">
        <div className="flex gap-4">
          <span className="material-symbols-outlined text-[#adaaaa] cursor-pointer hover:scale-105 hover:text-[#a2ffbf] transition-all">notifications</span>
          <span className="material-symbols-outlined text-[#adaaaa] cursor-pointer hover:scale-105 hover:text-[#a2ffbf] transition-all">settings</span>
        </div>
        <div className="w-8 h-8 rounded-full overflow-hidden border border-white/10 cursor-pointer active:scale-95 transition-all">
